...
15. **Apply from the web UI:** change the lights again, then click **smoke test** in the panel's **Saved settings** card — the lights restore and the light cards refresh on the same poll.
